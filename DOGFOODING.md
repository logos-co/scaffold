...
"$SCAFFOLD_BIN" test-node run --serial --block-create-timeout-ms 100 --retry-pending-blocks-timeout-ms 100 -- sh -c 'echo "rpc=$LGS_TEST_NODE_RPC_URL port=$LGS_TEST_NODE_PORT"'
```
